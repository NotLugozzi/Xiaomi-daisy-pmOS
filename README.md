...
I started merging my work with the postmarketos repo on gitlab, big thanks to maxnet for the help with merging and with the git workflow - i'll keep y'all updated 
